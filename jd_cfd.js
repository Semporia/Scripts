...
[task_local]
#京喜财富岛
1 * * * * https://cdn.jsdelivr.net/gh/Semporia/Scripts@main/jd_cfd.js, tag=京喜财富岛, img-url=https://cdn.jsdelivr.net/gh/Semporia/Quantumult-X@master/Bubble/Task/Mi_Sports.png, enabled=true

================Loon==============
[Script]
cron "1 * * * *" script-path=https://cdn.jsdelivr.net/gh/Semporia/Scripts@main/jd_cfd.js,tag=京喜财富岛
...
============小火箭=========
京喜财富岛 = type=cron,script-path=https://cdn.jsdelivr.net/gh/Semporia/Scripts@main/jd_cfd.js, cronexpr="1 * * * *", timeout=3600, enable=true
 */
