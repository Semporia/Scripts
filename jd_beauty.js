...
function getIsvToken() {
  let config = {
    ...
    headers: {
      'Host': 'api.m.jd.com',
      'accept': '*/*',
      'user-agent':$.isNode() ? (process.env.JD_USER_AGENT ? process.env.JD_USER_AGENT : (require('./USER_AGENTS').USER_AGENT)) : ($.getdata('JDUA') ? $.getdata('JDUA') : "JD4iPhone/167490 (iPhone; iOS 14.2; Scale/3.00)"),
