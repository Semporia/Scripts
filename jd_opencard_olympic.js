...
[task_local]
#奥运夺金牌开卡
10 0,21 * * * jd_opencard_olympic.js, tag=奥运夺金牌开卡, img-url=https://raw.githubusercontent.com/smiek2221/scripts/master/gua_olympic_opencard.png, enabled=true

================Loon==============
[Script]
cron "10 0,21 * * *" script-path= jd_opencard_olympic.js,tag=奥运夺金牌开卡

===============Surge=================
奥运夺金牌开卡 = type=cron,cronexp="10 0,21 * * *",wake-system=1,timeout=3600,script-path= jd_opencard_olympic.js

============小火箭=========
奥运夺金牌开卡 = type=cron,script-path= jd_opencard_olympic.js, cronexpr="10 0,21 * * *", timeout=3600, enable=true
*/
