...
[task_local]
#京东超级盒子
24 1,12 1-11 11 * https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_cjhz.js, tag=京东超级盒子, img-url=https://github.com/58xinian/icon/raw/master/jdgc.png, enabled=true

================Loon==============
[Script]
cron "24 1,12 1-11 11 *" script-path=https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_cjhz.js,tag=京东超级盒子

===============Surge=================
京东超级盒子 = type=cron,cronexp="24 1,12 1-11 11 *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_cjhz.js

============小火箭=========
京东超级盒子 = type=cron,script-path=https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_cjhz.js, cronexpr="24 1,12 1-11 11 *", timeout=3600, enable=true
 */
...
!(async () => {
    ...
    $.shareCoseList = [...new Set([...$.shareCoseList,'Af7yFYVjCYyXOz2brRZW7CczD3HGxYNfD5w7HXDIYCk','4tjTGFnjSNIeYcjfK3qePNIOrtbq2Yzq4nHY1q3adiA','YUnfajpScZ122lDY4vAoDA'])]
    //去助力与开箱
    for (let i = 0; i < cookiesArr.length; i++) {
        cookie = cookiesArr[i];
        if (cookie) {
