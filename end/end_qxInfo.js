...
入口：25.0复制整段话 http:/J4SfMsjCBFjZ3y 美妆好礼，示爱七夕，快来和我一起收情书抽乐园门票！￥m2qJmCaUFa%大家买买买都→猄栋

============Quantumultx===============
[task_local]
#8.4-8.15 七夕情报局🐶
36 0,10,21 4-15 8 * jd_qxInfo.js, tag=8.4-8.15 七夕情报局🐶, enabled=true

================Loon==============
[Script]
cron "36 0,10,21 4-15 8 *" script-path=jd_qxInfo.js,tag=8.4-8.15 七夕情报局🐶

===============Surge=================
8.4-8.15 七夕情报局🐶 = type=cron,cronexp="36 0,10,21 4-15 8 *",wake-system=1,timeout=3600,script-path=jd_qxInfo.js

============小火箭=========
8.4-8.15 七夕情报局🐶 = type=cron,script-path=jd_qxInfo.js, cronexpr="36 0,10,21 4-15 8 *", timeout=3600, enable=true
*/
...
!(async () => {
  ...
  console.log(`入口:\n25.0复制整段话 http:/J4SfMsjCBFjZ3y 美妆好礼，示爱七夕，快来和我一起收情书抽乐园门票！￥m2qJmCaUFa%大家买买买都→猄栋`)
