...
22.0复制整段话 Http:/JIaujN74OHOcKw 一起奔跑 为奥运加油 分千万京豆万元大奖￥Y072n3YR7a￥dakai鯨·=·岽A P/P

============Quantumultx===============
[task_local]
#7.31-8.10 全民奥运 激情奔跑
15 0,8 * * * jd_opencard_olympicRun.js, tag=7.31-8.10 全民奥运 激情奔跑, enabled=true

================Loon==============
[Script]
cron "15 0,8 * * *" script-path= jd_opencard_olympicRun.js,tag=7.31-8.10 全民奥运 激情奔跑

===============Surge=================
7.31-8.10 全民奥运 激情奔跑 = type=cron,cronexp="15 0,8 * * *",wake-system=1,timeout=3600,script-path= jd_opencard_olympicRun.js

============小火箭=========
7.31-8.10 全民奥运 激情奔跑 = type=cron,script-path= jd_opencard_olympicRun.js, cronexpr="15 0,8 * * *", timeout=3600, enable=true
*/
