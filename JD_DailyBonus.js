...
[Script]
京东多合一签到 = type=cron,cronexp=5 0 * * *,wake-system=1,timeout=60,script-path=https://raw.githubusercontent.com/Semporia/Scripts/main/JD_DailyBonus.js

获取京东Cookie = type=http-request,requires-body=1,pattern=^https:\/\/(api\.m|me-api|ms\.jr)\.jd\.com\/(client\.action\?functionId=signBean|user_new\/info\/GetJDUserInfoUnion\?|gw\/generic\/hy\/h5\/m\/appSign\?),script-path=https://raw.githubusercontent.com/Semporia/Scripts/main/JD_DailyBonus.js
...
[Script]
cron "5 0 * * *" tag=京东多合一签到, script-path=https://raw.githubusercontent.com/Semporia/Scripts/main/JD_DailyBonus.js
...
[task_local]
# 京东多合一签到
5 0 * * * https://raw.githubusercontent.com/Semporia/Scripts/main/JD_DailyBonus.js, tag=京东多合一签到, img-url=https://cdn.jsdelivr.net/gh/Semporia/Scripts@main/API-Icon/jd.png,enabled=true

[rewrite_local]
# 获取京东Cookie. 
^https:\/\/(api\.m|me-api)\.jd\.com\/(client\.action\?functionId=signBean|user_new\/info\/GetJDUserInfoUnion\?) url script-request-header https://raw.githubusercontent.com/Semporia/Scripts/main/JD_DailyBonus.js

# 获取钢镚签到body. 
^https:\/\/ms\.jr\.jd\.com\/gw\/generic\/hy\/h5\/m\/appSign\? url script-request-body https://raw.githubusercontent.com/Semporia/Scripts/main/JD_DailyBonus.js
