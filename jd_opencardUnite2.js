/*
9.1-9.6 联合开卡 [jd_opencardUnite2.js]
新增开卡脚本
一次性脚本
...
加购获得抽奖1次 有机会获得5京豆 (有可能是空气💨 默认不加购 如需加购请设置环境变量[opencardUnite2_addSku]为"true"
抽奖有机会获得京豆(有可能是空气💨
...
[task_local]
#9.1-9.6 联合开卡
28 7,20 1-6 9 * https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_opencardUnite2.js, tag=9.1-9.6 联合开卡, enabled=true

================Loon==============
[Script]
cron "28 7,20 1-6 9 *" script-path=https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_opencardUnite2.js,tag=9.1-9.6 联合开卡

===============Surge=================
9.1-9.6 联合开卡 = type=cron,cronexp="28 7,20 1-6 9 *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_opencardUnite2.js

============小火箭=========
9.1-9.6 联合开卡 = type=cron,script-path=https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_opencardUnite2.js, cronexpr="28 7,20 1-6 9 *", timeout=3600, enable=true
*/
...
opencard_addSku = $.isNode() ? (process.env.opencardUnite2_addSku ? process.env.opencardUnite2_addSku : `${opencard_addSku}`) : ($.getdata('opencardUnite2_addSku') ? $.getdata('opencardUnite2_addSku') : `${opencard_addSku}`);
  ...
  try{
    ...
    // if($.isCartAward == 0){
      ...
      if(opencard_addSku+"" != "true"){
        console.log('如需加购请设置环境变量[opencardUnite2_addSku]为"true"');
      }else await addCart();
