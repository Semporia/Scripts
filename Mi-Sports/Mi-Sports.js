...
Surge
[Script]
小米运动 = type=cron,cronexp="15 17 * * *",wake-system=1,timeout=3600,script-path=https://cdn.jsdelivr.net/gh/Semporia/Scripts/main/Mi-Sports/Mi-Sports.js
小米运动获取Token = type=http-response,pattern=^https:\/\/account\.huami\.com\/v2\/client\/login, requires-body=1, max-size=0, script-path=backUp/Mi-Sports.js
圈X
[task_local]
# 小米运动
15 17 * * * xmbs.js, tag=小米运动, img-url=https://cdn.jsdelivr.net/gh/Semporia/Scripts/main/API-Icon/Mi-Sports.png, enabled=true
[rewrite_local]
# 小米运动获取Token
^https:\/\/account\.huami\.com\/v2\/client\/login url script-response-body https://cdn.jsdelivr.net/gh/Semporia/Scripts/main/Mi-Sports/Mi-Sports.js
Loon
[Script]
cron "15 17 * * *" script-path=xmbs.js, tag=小米运动
http-response ^https:\/\/account\.huami\.com\/v2\/client\/login script-path=https://cdn.jsdelivr.net/gh/Semporia/Scripts/main/Mi-Sports/Mi-Sports.js, requires-body=true, timeout=3600, tag=小米运动获取Token
 */
