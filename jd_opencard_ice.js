/*
8.18-8.31 冰爽来袭 玩撞一夏 [jd_opencard_ice.js]
新增开卡脚本
一次性脚本
...
关注10京豆 (有可能是空气💨
加购没有豆只获得游戏机会 (默认不加购 如需加购请设置环境变量[opencard_ice_addSku]为"true"
...
[task_local]
#8.18-8.31 冰爽来袭 玩撞一夏
18 9,22 18-31 8 * https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_opencard_ice.js, tag=8.18-8.31 冰爽来袭 玩撞一夏, enabled=true

================Loon==============
[Script]
cron "18 9,22 18-31 8 *" script-path=https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_opencard_ice.js,tag=8.18-8.31 冰爽来袭 玩撞一夏

===============Surge=================
8.18-8.31 冰爽来袭 玩撞一夏 = type=cron,cronexp="18 9,22 18-31 8 *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_opencard_ice.js

============小火箭=========
8.18-8.31 冰爽来袭 玩撞一夏 = type=cron,script-path=https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_opencard_ice.js, cronexpr="18 9,22 18-31 8 *", timeout=3600, enable=true
*/
...
async function run(){
  try{
    ...
    $.log("加购: " + $.addSku)
    if(!$.addSku && opencardIce_addSku+"" != "true") console.log('如需加购请设置环境变量[opencard_ice_addSku]为"true"');
    if(!$.addSku && opencardIce_addSku == "true") await saveTask('加购', 21, 21);
    if(!$.addSku && opencardIce_addSku == "true") await $.wait(1000)
    await getActorUuid()
